...
import com.dataminer.algorithm.ArraysAlgos;
...
public class Itemset extends AbstractOrderedItemset{
	...
	public Itemset cloneItemSetMinusOneItem(Integer itemToRemove) {
		...
		for(int j =0; j < this.itemset.length; j++){
			...
			if(this.itemset[j] != itemToRemove){
	...
	public Itemset intersection(Itemset itemset2) {
		int [] intersection = ArraysAlgos.intersectTwoSortedArrays(getItems(), itemset2.getItems());
